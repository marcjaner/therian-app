...
const MOCK_RESULTS = [
  {
    ...
    emoji: "🐺",
    score: 94,
    trait: "pack leader energy, deep resonance, low harmonics",
  },
  {
    rank: 2,
    animal: "Raven",
    emoji: "🐦‍⬛",
    score: 71,
    trait: "sharp attack, erratic rhythm, high pitch spikes",
  },
  {
    rank: 3,
    animal: "Fox",
    emoji: "🦊",
    score: 58,
    trait: "midrange brightness, quick cadence, adaptive patterns",
  },
];
